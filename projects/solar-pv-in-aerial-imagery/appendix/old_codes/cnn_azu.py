...
training_set = train_datagen.flow_from_directory('/Users/azucenamv/Documents/MIDS/ML/Kaggle/Data/training',
                                                 target_size = (101, 101),
                                                 batch_size = 32,
                                                 class_mode = 'binary')

test_set = test_datagen.flow_from_directory('/Users/azucenamv/Documents/MIDS/ML/Kaggle/Data/testing',
                                            target_size = (101, 101),
                                            batch_size = 32,
                                            class_mode = 'binary')
...
proba = []
path = '/Users/azucenamv/Documents/MIDS/ML/Kaggle/Data/testing_nolabels/'
images=os.listdir(path)
for img in images:
    test_image = image.load_img('/Users/azucenamv/Documents/MIDS/ML/Kaggle/Data/testing_nolabels/'+img, target_size = (101,101))
...
submission_file.to_csv('/Users/azucenamv/Documents/MIDS/ML/Kaggle/Data/submission4.csv',
                           columns=['id','score'],
                           index=False)
