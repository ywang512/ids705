...
training_set = train_datagen.flow_from_directory('/Users/wang/Desktop/solar-pv-in-aerial-imagery/data3/training',
                                                 target_size = (101, 101),
                                                 batch_size = 32,
                                                 class_mode = 'binary')

'''
test_set = test_datagen.flow_from_directory('/Users/wang/Desktop/solar-pv-in-aerial-imagery/data3/testing',
                                            target_size = (101, 101),
                                            batch_size = 32,
                                            class_mode = 'binary')
'''
...
proba = []
path = '/Users/wang/Desktop/solar-pv-in-aerial-imagery/data3/testing_nolabels/'
...
submission_file.to_csv('/Users/wang/Desktop/solar-pv-in-aerial-imagery/data3/submission_yw_final.csv',
                           columns=['id','score'],
                           index=False)
